...
# Находит высоту, проведённую  из меньшего угла треугольника
...
# maxSpace - минимальное расстояние от точки до стороны треугольника
...
if lenAB + lenBC <= lenCA or lenBC + lenCA <= lenAB or lenCA + lenAB <= lenBC:
    ...
    maxSpace = max(hAB, hBC, hAC)
    print('Расстояние до дальнейшей прямой равно ', maxSpace)
